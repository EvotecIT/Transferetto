...
### Password (Default)
```powershell
Connect-SCP -Server <string> -Credential <pscredential> [-Port <int>] [-PrivateKeyPassphrase <string>] [-KeyboardInteractive] [-AcceptAnyHostKey] [-ExpectedHostKeyFingerprint <string[]>] [-HostKeyPolicy <TransferettoSshHostKeyPolicy>] [-KnownHostsPath <string>] [-KeepAliveIntervalSeconds <int>] [-ConnectionTimeoutSeconds <int>] [-RetryAttempts <int>] [-ProxyType <TransferettoSshProxyType>] [-ProxyHost <string>] [-ProxyPort <int>] [-ProxyCredential <pscredential>] [<CommonParameters>]
```

### ClearText
```powershell
Connect-SCP -Server <string> -Username <string> -Password <string> [-Port <int>] [-PrivateKeyPassphrase <string>] [-KeyboardInteractive] [-AcceptAnyHostKey] [-ExpectedHostKeyFingerprint <string[]>] [-HostKeyPolicy <TransferettoSshHostKeyPolicy>] [-KnownHostsPath <string>] [-KeepAliveIntervalSeconds <int>] [-ConnectionTimeoutSeconds <int>] [-RetryAttempts <int>] [-ProxyType <TransferettoSshProxyType>] [-ProxyHost <string>] [-ProxyPort <int>] [-ProxyCredential <pscredential>] [<CommonParameters>]
```

### PrivateKey
```powershell
Connect-SCP -Server <string> -Username <string> -PrivateKey <string> [-Port <int>] [-PrivateKeyPassphrase <string>] [-KeyboardInteractive] [-AcceptAnyHostKey] [-ExpectedHostKeyFingerprint <string[]>] [-HostKeyPolicy <TransferettoSshHostKeyPolicy>] [-KnownHostsPath <string>] [-KeepAliveIntervalSeconds <int>] [-ConnectionTimeoutSeconds <int>] [-RetryAttempts <int>] [-ProxyType <TransferettoSshProxyType>] [-ProxyHost <string>] [-ProxyPort <int>] [-ProxyCredential <pscredential>] [<CommonParameters>]
```
...
### EXAMPLE 1
```powershell
Connect-SCP -Server 'Value' -Credential Get-Credential
```


### EXAMPLE 2
```powershell
Connect-SCP -Server 'Value' -Username 'Name' -Password 'Value'
```


### EXAMPLE 3
```powershell
Connect-SCP -Server 'Value' -Username 'Name' -PrivateKey 'Value'
```
