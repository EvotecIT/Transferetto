...
### __AllParameterSets
```powershell
Set-FTPStreamPosition -StreamSession <TransferettoFtpStreamSession> -Offset <long> [-Origin <SeekOrigin>] [<CommonParameters>]
```
...
### EXAMPLE 1
```powershell
Set-FTPStreamPosition -StreamSession 'Value' -Offset 1
```
