...
### __AllParameterSets
```powershell
Move-FTPFile -Client <TransferettoFtpSession> -RemoteSource <string> -RemoteDestination <string> [-RemoteExists <FtpRemoteExists>] [<CommonParameters>]
```
...
### EXAMPLE 1
```powershell
Move-FTPFile -Client 'Value' -RemoteSource 'Value' -RemoteDestination 'Value'
```
