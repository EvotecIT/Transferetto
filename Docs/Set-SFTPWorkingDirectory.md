...
### __AllParameterSets
```powershell
Set-SFTPWorkingDirectory -SftpClient <TransferettoSftpSession> -Path <string> [-PassThru] [<CommonParameters>]
```
...
### EXAMPLE 1
```powershell
Set-SFTPWorkingDirectory -SftpClient 'Value' -Path 'C:\Path'
```
