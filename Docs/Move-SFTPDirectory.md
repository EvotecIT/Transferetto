...
### __AllParameterSets
```powershell
Move-SFTPDirectory -SftpClient <TransferettoSftpSession> -SourcePath <string> -DestinationPath <string> [-PosixRename] [-Suppress] [<CommonParameters>]
```
...
### EXAMPLE 1
```powershell
Move-SFTPDirectory -SftpClient 'Value' -SourcePath 'C:\Path' -DestinationPath 'C:\Path'
```
