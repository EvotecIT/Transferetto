...
### Password (Default)
```powershell
Connect-SFTP -Server <string> -Credential <pscredential> [-Port <int>] [-PrivateKeyPassphrase <string>] [-KeyboardInteractive] [-AcceptAnyHostKey] [-ExpectedHostKeyFingerprint <string[]>] [-HostKeyPolicy <TransferettoSshHostKeyPolicy>] [-KnownHostsPath <string>] [-KeepAliveIntervalSeconds <int>] [-ConnectionTimeoutSeconds <int>] [-RetryAttempts <int>] [-ProxyType <TransferettoSshProxyType>] [-ProxyHost <string>] [-ProxyPort <int>] [-ProxyCredential <pscredential>] [<CommonParameters>]
```

### ClearText
```powershell
Connect-SFTP -Server <string> -Username <string> -Password <string> [-Port <int>] [-PrivateKeyPassphrase <string>] [-KeyboardInteractive] [-AcceptAnyHostKey] [-ExpectedHostKeyFingerprint <string[]>] [-HostKeyPolicy <TransferettoSshHostKeyPolicy>] [-KnownHostsPath <string>] [-KeepAliveIntervalSeconds <int>] [-ConnectionTimeoutSeconds <int>] [-RetryAttempts <int>] [-ProxyType <TransferettoSshProxyType>] [-ProxyHost <string>] [-ProxyPort <int>] [-ProxyCredential <pscredential>] [<CommonParameters>]
```

### PrivateKey
```powershell
Connect-SFTP -Server <string> -Username <string> -PrivateKey <string> [-Port <int>] [-PrivateKeyPassphrase <string>] [-KeyboardInteractive] [-AcceptAnyHostKey] [-ExpectedHostKeyFingerprint <string[]>] [-HostKeyPolicy <TransferettoSshHostKeyPolicy>] [-KnownHostsPath <string>] [-KeepAliveIntervalSeconds <int>] [-ConnectionTimeoutSeconds <int>] [-RetryAttempts <int>] [-ProxyType <TransferettoSshProxyType>] [-ProxyHost <string>] [-ProxyPort <int>] [-ProxyCredential <pscredential>] [<CommonParameters>]
```
...
### EXAMPLE 1
```powershell
Connect-SFTP -Server 'Value' -Credential Get-Credential
```


### EXAMPLE 2
```powershell
Connect-SFTP -Server 'Value' -Username 'Name' -Password 'Value'
```


### EXAMPLE 3
```powershell
Connect-SFTP -Server 'Value' -Username 'Name' -PrivateKey 'Value'
```
