...
### __AllParameterSets
```powershell
Test-SFTPSymbolicLink -SftpClient <TransferettoSftpSession> -Path <string> [<CommonParameters>]
```
...
### EXAMPLE 1
```powershell
Test-SFTPSymbolicLink -SftpClient 'Value' -Path 'C:\Path'
```
